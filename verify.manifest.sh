...
#
# THE BACK-MERGE OF dev INTO THIS BRANCH: the rounds above are disjoint from
# this one, different files and no test renamed or removed in either, so the
# number below is MEASURED on the merge product with one testroster run here
# and not added up.
MIN_DECLARED_TESTS=697
